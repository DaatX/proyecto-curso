...
if(isset($_COOKIE['user_id'])){
 ...
 if(isset($_POST['update_now'])){
    ...
    $verify_comment = $cBD->prepare("SELECT * FROM `comentario` WHERE id = ? AND comment = ? ORDER BY date DESC");
...
<div class="text">Tus comentarios</div>
...
<section class="edita-comentario">
   ...
   <form action="" method="post">
      ...
      <textarea name="update_box" class="caja" maxlength="1000" required placeholder="Por favor ingrese su comentario" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
         <a href="comentario.php" class="inline-opcion-btn">cancelar edición</a>
...
<section class="comentario">
   ...
   <div class="ver-comentario">
      ...
      <div class="comentario-contenido"><p> - <?= $fetch_content['title']; ?> - </p><a href="ver-video.php?get_id=<?= $fetch_content['id']; ?>">view content</a></div>
         <div class="usuario">
